...
public:
	...
	inline bool SetParamsEx(bool engine, bool lights, bool alarm, bool doors, bool bonnet, bool boot, bool objective) const
		{ return sampgdk::SetVehicleParamsEx(m_Id, engine, lights, alarm, doors, bonnet, boot, objective); }
	inline bool GetParamsEx(bool &engine, bool &lights, bool &alarm, bool &doors, bool &bonnet, bool &boot, bool &objective) const
